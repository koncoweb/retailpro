  ...
  return (
    <MainLayout>
      <div className="h-[calc(100vh-7rem)] flex gap-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              {filteredProducts.map((product) => (
                <button
                  ...
                  className="p-4 rounded-xl bg-muted/50 hover:bg-primary/10 border border-transparent hover:border-primary/30 transition-all text-left group animate-scale-in"
                >
                  <div className="aspect-square rounded-lg bg-gradient-to-br from-primary/20 to-info/20 mb-3 flex items-center justify-center">
        ...
        {/* Cart Section */}
        <div className="w-96 flex flex-col bg-card rounded-xl border overflow-hidden">
          {/* Cart Header */}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {cart.length === 0 ? (
              ...
              cart.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 animate-slide-in-left"
                >
          ...
          <div className="border-t p-4 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <Button variant="posSecondary" size="pos" className="flex-col gap-1">
