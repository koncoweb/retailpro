  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-r from-primary to-info text-primary-foreground shadow-md hover:shadow-lg hover:opacity-90 active:scale-[0.98]",
        sidebar: "bg-sidebar-accent text-sidebar-accent-foreground hover:bg-sidebar-primary hover:text-sidebar-primary-foreground",
        pos: "bg-primary text-primary-foreground text-lg font-semibold shadow-lg hover:shadow-xl hover:bg-primary/90 active:scale-[0.97]",
        posSecondary: "bg-secondary text-secondary-foreground border border-border hover:bg-accent active:scale-[0.98]",
        posPayment: "bg-gradient-to-r from-success to-primary text-success-foreground text-lg font-bold shadow-lg hover:shadow-xl hover:opacity-95 active:scale-[0.97]",
      },
      size: {
